            ...
            <div class="row align-items-center"
                ...
                <div class="col-12 col-md-6 mb-4 col order-2 order-md-1">
                    <div class="banner-content text-lg-start text-center">
                        ...
                        <h1>Los Cabos Airport Private Service</h1>
                        <p class="mb-4">
                            Eliker Transfer provide Private, safe and reliable Transportation from Los Cabo Airport to
                            your Hotel in different parts of the area, like San Jose del Cabo, Pueto Los Cabos Area,
                            Turist Corridor, Cabo San Lucas, Pafic Area, Todos Santos, La Paz, Los Barriles. <br><br>
                            We know that when you are landing at Los Cabos Airport the only thing you want is to get to
                            your Hotel or destination as fast as possible and that’s why we provide our Transportation
                            service which you have to pre-book so we can be waiting for you at your arrival. Remember
                            our transportation is private, safe and fast. <br><br>
                            Eliker Transportation we will provide private transportation to and from your Hotel, Condo
                            or house in any destination in Los Cabos either One Way Transportation or Roundtrip
                            Transportation.
                        </p>
                ...
                <div class="col-12 col-md-6 mb-4 d-block d-md-none col order-1 order-md-2">
    ...
    <div class="container">
        <div class="row justify-content-center align-items-center">
            ...
            <div class="col-12 col-md-3">
                <h6 class="text-center textos-cards"><img src="images/zona1.png" alt=""> Airport SJD to zone 1</h6>
                <div class="card zona1 mb-3" style="max-width: 18rem;">
                    <div class="card-header text-center cabo"><span style="margin-top:2rem; margin-bottom:2rem;">San
                            Jose del Cabo</span></div>
                    <div class="card-body text-success">
                        <h5 class="card-title" style="text-transform: none;">SUV or Similar</h5>
                        <p class="card-text" style="color: #757575;">
                            <img src="images/usuario.png" alt=""> 1 to 5 passengers
                        </p>
                        <div class="row">
                            <div class="col-6">
                            ...
                            <div class="col-6" style="color: #414141;">
                                <p>
                                    One way <br>
                                    <sup>$</sup><b>60</b> USD
                                </p>
                    ...
                    <div class=" card-footer bg-transparent text-center">
                        <a class=" boton btn-zona1 btn-lg" type="button">Botón</a>
                    </div>
                </div>
                <!-- Segunda card -->
                <div class="card zona1 mb-3" style="max-width: 18rem;">
                    <div class="card-body text-success">
                        <h5 class="card-title" style="text-transform: none;">Van or Similar</h5>
                        <p class="card-text" style="color: #757575;">
                            <img src="images/users.png" alt=""> 6 to 10 passengers
                        </p>
                        <div class="row">
                            <div class="col-6">
                                <p style="color: #414141;">
            ...
            <!-- empieza zona 2 -->
            <div class="col-12 col-md-3">
                <h6 class="text-center textos-cards"><img src="images/zona2.png" alt=""> Airport SJD to zone 2</h6>
                <div class="card zona2 mb-3" style="max-width: 18rem;">
                    <div class="card-header text-center puerto" style="font-size: .7rem;">Puerto
                        Los Cabos <br>Tourist Corridor</div>
                    <div class="card-body text-success">
                        <h5 class="card-title" style="text-transform: none;">SUV or Similar</h5>
                        <p class="card-text" style="color: #757575;">
                            <img src="images/usuario.png" alt=""> 1 to 5 passengers
                    ...
                    <div class="card-footer text-center">
                        <a class=" boton btn-zona2 btn-lg" type="button">Botón</a>
                    </div>
                </div>
                <!-- empieza card 2 -->
                <div class="card zona2 mb-3" style="max-width: 18rem;">
            ...
            <!-- empieza zona 3 -->
            <div class="col-12 col-md-3">
                <h6 class="text-center textos-cards"><img src="images/zona3.png" alt=""> Airport SJD to zone 3</h6>
                <div class="card zona3 mb-3" style="max-width: 18rem;">
                    <div class="card-header text-center lucas">Cabo San Lucas <br></div>
                    <div class="card-body text-success">
                        <h5 class="card-title" style="text-transform: none;">SUV or Similar</h5>
                        <p class="card-text" style="color: #757575;">
                            <img src="images/usuario.png" alt=""> 1 to 5 passengers
                    ...
                    <div class="card-footer text-center">
                        <a class=" boton btn-zona3 btn-lg" type="button">Botón</a>
                    </div>
                </div>
            ...
            <!-- empieza zona 4 -->
            <div class="col-12 col-md-3">
                <h6 class="text-center textos-cards"><img src="images/zona4.png" alt=""> Airport SJD to zone 4</h6>
                <div class="card zona4 mb-3" style="max-width: 18rem;">
                    <div class="card-header pacific text-center">Pacific Area <br></div>
                    <div class="card-body text-success">
                        <h5 class="card-title" style="text-transform: none;">SUV or Similar</h5>
                        <p class="card-text" style="color: #757575;">
                            <img src="images/usuario.png" alt=""> 1 to 5 passengers
                    ...
                    <div class="card-footer text-center">
                        <a class=" boton btn-zona4 btn-lg" type="button">Botón</a>
                    </div>
                </div>
                ...
                <div class="row g-2">
                    ...
                    <div class="col-6">
                        <ul>
                            ...
                            <li>Turnpike</li><br>
                            <li>Water and beer</li><br>
                            <li>Grocery stop additional cost</li><br>
                        </ul>
                    </div>
                </div>
            </div>
...
<section class="about-us pb-6 pt-6" style="
    ...
    <div class="container">
        <div class="section-title mb-6 w-50 mx-auto text-center">
            ...
            <h2 class="mb-1">
                Find <span class="theme">Travel Perfection</span>
            </h2>
            <p>
                        ...
                        <div class="trend-item1">
                            <div class="trend-image position-relative rounded">
                                ...
                                <div
                                    ...
                                    <div class="trend-content-title">
                                        <h5 class="mb-0">
                                            <a href="tour-grid.html" class="theme1">Italy</a>
                                        </h5>
                        ...
                        <div class="trend-item1">
                            <div class="trend-image position-relative rounded">
                                ...
                                <div
                                    ...
                                    <div class="trend-content-title">
                                        <h5 class="mb-0">
                                            <a href="tour-grid.html" class="theme1">Tokyo</a>
                                        </h5>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 mb-4">
                    <div class="trend-item rounded box-shadow">
                        ...
                        <div class="trend-content p-4 pt-5 position-relative">
                            ...
                            <h5 class="theme mb-1">
                                <i class="flaticon-location-pin"></i> Croatia
                            </h5>
                            <h3 class="mb-1">
                            ...
                            <div class="entry-meta">
                                <div class="entry-author d-flex align-items-center">
                                    <p class="mb-0">
                                        <span class="theme fw-bold fs-5"> $170.00</span> | Per
                                        person
                                    </p>
                                </div>
                            </div>
                    ...
                    <div class="trend-item box-shadow rounded">
                        ...
                        <div class="trend-content p-4 pt-5 position-relative">
                            ...
                            <div class="entry-meta">
                                <div class="entry-author d-flex align-items-center">
                                    <p class="mb-0">
                                        <span class="theme fw-bold fs-5"> $180.00</span> | Per
                                        person
                                    </p>
                                </div>
                            </div>
                    ...
                    <div class="trend-item box-shadow rounded">
                        ...
                        <div class="trend-content p-4 pt-5 position-relative">
                            ...
                            <div class="entry-meta">
                                <div class="entry-author d-flex align-items-center">
                                    <p class="mb-0">
                                        <span class="theme fw-bold fs-5"> $260.00</span> | Per
                                        person
                                    </p>
                                </div>
                            </div>
                ...
                <div class="col-lg-5 mb-4">
                    <div class="trend-item1 rounded box-shadow mb-4">
                        <div class="trend-image position-relative">
                            ...
                            <div class="trend-content1 p-4">
                                <h5 class="theme1 mb-1">
                                    <i class="flaticon-location-pin"></i> Norway
                                </h5>
                                <h3 class="mb-1 white">
                                    <a href="tour-grid.html" class="white">Norway Lake</a>
                                </h3>
                                <div class="rating-main d-flex align-items-center pb-2">
                                    <div class="rating">
                                        <span class="fa fa-star checked"></span>
                                ...
                                <div class="entry-meta d-flex align-items-center justify-content-between">
                                    <div class="entry-author d-flex align-items-center">
                                        <p class="mb-0 white">
                                            <span class="theme1 fw-bold fs-5"> $180.00</span> |
                                            Per person
                                        </p>
                                    </div>
                                    <div class="entry-author">
                    ...
                    <div class="trend-item1 rounded box-shadow mb-4">
                        <div class="trend-image position-relative">
                            ...
                            <div class="trend-content1 p-4">
                                <h5 class="theme1 mb-1">
                                    <i class="flaticon-location-pin"></i> Egpyt
                                </h5>
                                <h3 class="mb-1 white">
                                    <a href="tour-grid.html" class="white">Pyramid Land</a>
                                </h3>
                                <div class="rating-main d-flex align-items-center pb-2">
                                    <div class="rating">
                                        <span class="fa fa-star checked"></span>
                    ...
                    <div class="trend-item1 rounded box-shadow">
                        <div class="trend-image position-relative">
                            ...
                            <div class="trend-content1 p-4">
                                <h5 class="theme1 mb-1">
                                    <i class="flaticon-location-pin"></i> Usa
                                </h5>
                                <h3 class="mb-1 white">
                                    <a href="tour-grid.html" class="white">New York City</a>
                                </h3>
                                <div class="rating-main d-flex align-items-center pb-2">
                                    <div class="rating">
                                        <span class="fa fa-star checked"></span>
                                ...
                                <div class="entry-meta d-flex align-items-center justify-content-between">
                                    <div class="entry-author d-flex align-items-center">
                                        <p class="mb-0 white">
                                            <span class="theme1 fw-bold fs-5"> $140.00</span> |
                                            Per person
                                        </p>
                                    </div>
                                    <div class="entry-author">
                        ...
                        <div class="col-lg-6 col-md-6 mb-4">
                            <div class="trend-item rounded box-shadow">
                                ...
                                <div class="trend-content p-4 pt-5 position-relative bg-white">
                                    ...
                                    <h3 class="mb-1">
                                        <a href="tour-grid.html">Barcelona city beach</a>
                                    </h3>
                                    <div class="rating-main d-flex align-items-center pb-2">
                                        <div class="rating">
                                            <span class="fa fa-star checked"></span>
                        ...
                        <div class="col-lg-6 col-md-6 mb-4">
                            <div class="trend-item rounded box-shadow">
                                ...
                                <div class="trend-content p-4 pt-5 position-relative bg-white">
                                    ...
                                    <h5 class="theme mb-1">
                                        <i class="flaticon-location-pin"></i> Indonesia
                                    </h5>
                                    <h3 class="mb-1">
                                        <a href="tour-grid.html">Bali Province</a>
                                    </h3>
                                    <div class="rating-main d-flex align-items-center pb-2">
                                        <div class="rating">
                                            <span class="fa fa-star checked"></span>
                                    ...
                                    <div class="entry-meta">
                                        <div class="entry-author d-flex align-items-center">
                                            <p class="mb-0">
                                                <span class="theme fw-bold fs-5"> $210.00</span> |
                                                Per person
                                            </p>
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-6 col-md-6 mb-4">
                            <div class="trend-item rounded box-shadow">
                                ...
                                <div class="trend-content p-4 pt-5 position-relative bg-white">
                                    ...
                                    <h5 class="theme mb-1">
                                        <i class="flaticon-location-pin"></i> Russia
                                    </h5>
                                    <h3 class="mb-1">
                                        <a href="tour-grid.html">Red City Land</a>
                                    </h3>
                                    <div class="rating-main d-flex align-items-center pb-2">
                                        <div class="rating">
                                            <span class="fa fa-star checked"></span>
                                    ...
                                    <div class="entry-meta">
                                        <div class="entry-author d-flex align-items-center">
                                            <p class="mb-0">
                                                <span class="theme fw-bold fs-5"> $120.00</span> |
                                                Per person
                                            </p>
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-6 col-md-6 mb-4">
                            <div class="trend-item rounded box-shadow">
                                ...
                                <div class="trend-content p-4 pt-5 position-relative bg-white">
                                    ...
                                    <h5 class="theme mb-1">
                                        <i class="flaticon-location-pin"></i> Bangladesh
                                    </h5>
                                    <h3 class="mb-1">
                                        <a href="tour-grid.html">Cox's bazar Beach</a>
                                    </h3>
                                    <div class="rating-main d-flex align-items-center pb-2">
                                        <div class="rating">
                                            <span class="fa fa-star checked"></span>
                                    ...
                                    <div class="entry-meta">
                                        <div class="entry-author d-flex align-items-center">
                                            <p class="mb-0">
                                                <span class="theme fw-bold fs-5"> $100.00</span> |
                                                Per person
                                            </p>
                                        </div>
                                    </div>
...
<section class="discount-action pt-6" style="
            ...
            <div class="call-banner-inner w-75 mx-auto text-center px-5">
                <div class="trend-content-main">
                    <div class="trend-content mb-5 pb-2 px-5">
                        ...
                        <h2>
                            <a href="detail-fullwidth.html/index.html">Explore Your Life,
...
<section class="our-team pb-6">
    <div class="container">
        <div class="section-title mb-6 w-75 mx-auto text-center">
            ...
            <h2 class="mb-1">
                Meet Our <span class="theme">Excellent Guides</span>
            </h2>
            <p>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                eiusmod tempor incididunt ut labore.
                    ...
                    <div class="trend-item box-shadow bg-white mb-4 rounded overflow-hidden">
                        ...
                        <div class="trend-content-main p-4 pb-2">
                            <div class="trend-content">
                                ...
                                <h4>
                                    <a href="detail-1.html">How a developer duo at Deutsche Bank keep remote
                                        alive.</a>
                                </h4>
                                <p class="mb-3">
                    ...
                    <div class="trend-item box-shadow bg-white mb-4 rounded overflow-hidden">
                        ...
                        <div class="trend-content-main p-4 pb-2">
                            <div class="trend-content">
                                ...
                                <h4>
                                    <a href="detail-1.html">Inspire Runner with Autism Graces of Women's Running</a>
                                </h4>
                                <p class="mb-3">
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                                    sed do eiusmod
                    ...
                    <div class="trend-item box-shadow bg-white mb-4 rounded overflow-hidden">
                        ...
                        <div class="trend-content-main p-4 pb-2">
                            <div class="trend-content">
                                ...
                                <h4>
                                    <a href="detail-1.html">Services To Grow Your Business Sell Affiliate
                                        Products</a>
                                </h4>
                                <p class="mb-3">
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit,
