            ...
            <div class="col-12 col-md-6">
                ...
                <div class="row g-2">
                    <div class="col-6">
                        <p>
                        <ul>
                            <li><i style="color: #00c4cc;" class="icon-check"></i> Baby seat</li> <br>
                            <li><i style="color: #00c4cc;" class="icon-check"></i> Car seat</li><br>
                            <li><i style="color: #00c4cc;" class="icon-check"></i> Boster seat</li><br>
                            <li><i style="color: #00c4cc;" class="icon-check"></i> Bilingual driver</li>
                        </ul>
                        </p>
                    </div>
                    <div class="col-6">
                        <ul>
                            <li><i style="color: #00c4cc;" class="icon-check"></i> Travel insurance</li><br>
                            <li><i style="color: #00c4cc;" class="icon-check"></i> Turnpike</li><br>
                            <li><i style="color: #00c4cc;" class="icon-check"></i> Water and beer</li><br>
                            <li><i class="icon-close"></i> Grocery stop additional cost</li><br>
                        </ul>
                    </div>
                </div>
